...
const ALLOWED_ORIGINS = new Set(['https://ondam-web.pages.dev', 'https://localhost', 'https://easy-mode-test.ondam-web-demo.pages.dev', 'https://guardian-test.ondam-web-demo.pages.dev']);
