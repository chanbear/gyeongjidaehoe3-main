...
const I18N = {
  ...
  zh: {
    ...
    'error.aiVoice': '现在暂时无法分析。请稍后再试。',
      ...
      'onboard.guardian.desc': '收到危险短信时可以立即通知子女，<br>使用紧急求助按钮拨打电话时也会用到。<br>如果不需要，可以跳过。',
      'onboard.login.desc': '请输入注册时使用的电话号码和密码。',
      'onboard.login.submit': '登录',
      'onboard.login.title': '登录',
      'onboard.login.toSignup': '还没有账户？注册',
      'onboard.login.voice': '请输入电话号码和密码登录。',
      'onboard.signup.desc': '用电话号码和密码创建账户。<br>使用这个账户，在其他设备上也能继续使用您的信息。',
      'onboard.signup.errorGeneric': '注册失败了，请稍后再试',
      'onboard.signup.errorPhoneExists': '该电话号码已注册，请登录',
      'onboard.signup.pinLabel': '密码（4位数字）',
      'onboard.signup.submit': '注册',
      'onboard.signup.title': '注册账户',
      'onboard.signup.toLogin': '已经有账户了？去登录',
      'onboard.signup.voice': '请输入姓名、电话号码和4位数字密码进行注册。',
  },
  vi: {
    ...
    'error.aiVoice': 'Hiện tại chưa thể phân tích. Hãy thử lại sau ít phút.',
      ...
      'onboard.guardian.desc': 'Dùng để báo ngay cho con cái khi nhận được tin nhắn nguy hiểm,<br>hoặc khi gọi điện bằng nút trợ giúp khẩn cấp.<br>Nếu không muốn, bạn có thể bỏ qua.',
      'onboard.login.desc': 'Vui lòng nhập số điện thoại và mật khẩu đã dùng khi đăng ký.',
      'onboard.login.submit': 'Đăng nhập',
      'onboard.login.title': 'Đăng nhập',
      'onboard.login.toSignup': 'Chưa có tài khoản? Đăng ký',
      'onboard.login.voice': 'Vui lòng nhập số điện thoại và mật khẩu để đăng nhập.',
      'onboard.signup.desc': 'Tạo tài khoản bằng số điện thoại và mật khẩu.<br>Với tài khoản này, bạn có thể tiếp tục sử dụng thông tin của mình trên thiết bị khác.',
      'onboard.signup.errorGeneric': 'Đăng ký thất bại, vui lòng thử lại sau',
      'onboard.signup.errorPhoneExists': 'Số điện thoại này đã được đăng ký. Vui lòng đăng nhập',
      'onboard.signup.pinLabel': 'Mật khẩu (4 chữ số)',
      'onboard.signup.submit': 'Đăng ký',
      'onboard.signup.title': 'Đăng ký tài khoản',
      'onboard.signup.toLogin': 'Đã có tài khoản? Đăng nhập',
      'onboard.signup.voice': 'Vui lòng nhập tên, số điện thoại và mật khẩu 4 chữ số để đăng ký.',
  },
  th: {
    ...
    'error.aiVoice': 'ตอนนี้ยังวิเคราะห์ไม่ได้ กรุณาลองใหม่อีกครั้งในภายหลัง',
      ...
      'onboard.guardian.desc': 'ใช้แจ้งบุตรหลานทันทีเมื่อได้รับข้อความอันตราย<br>หรือใช้เมื่อกดปุ่มขอความช่วยเหลือฉุกเฉินเพื่อโทรออก<br>หากไม่ต้องการสามารถข้ามได้',
      'onboard.login.desc': 'กรุณากรอกเบอร์โทรศัพท์และรหัสผ่านที่ใช้ตอนสมัครสมาชิก',
      'onboard.login.submit': 'เข้าสู่ระบบ',
      'onboard.login.title': 'เข้าสู่ระบบ',
      'onboard.login.toSignup': 'ยังไม่มีบัญชี? สมัครสมาชิก',
      'onboard.login.voice': 'กรุณากรอกเบอร์โทรศัพท์และรหัสผ่านเพื่อเข้าสู่ระบบ',
      'onboard.signup.desc': 'สร้างบัญชีด้วยเบอร์โทรศัพท์และรหัสผ่าน<br>ใช้บัญชีนี้เพื่อใช้ข้อมูลของคุณต่อเนื่องได้จากอุปกรณ์เครื่องอื่น',
      'onboard.signup.errorGeneric': 'สมัครสมาชิกไม่สำเร็จ กรุณาลองใหม่อีกครั้งภายหลัง',
      'onboard.signup.errorPhoneExists': 'เบอร์โทรศัพท์นี้สมัครสมาชิกแล้ว กรุณาเข้าสู่ระบบ',
      'onboard.signup.pinLabel': 'รหัสผ่าน (ตัวเลข 4 หลัก)',
      'onboard.signup.submit': 'สมัครสมาชิก',
      'onboard.signup.title': 'สมัครสมาชิก',
      'onboard.signup.toLogin': 'มีบัญชีอยู่แล้ว? เข้าสู่ระบบ',
      'onboard.signup.voice': 'กรุณากรอกชื่อ เบอร์โทรศัพท์ และรหัสผ่านตัวเลข 4 หลักเพื่อสมัครสมาชิก',
  },
  uz: {
    ...
    'error.aiVoice': "Hozir tahlil qilib bo'lmadi. Birozdan so'ng qayta urinib ko'ring.",
      ...
      'onboard.guardian.desc': 'Xavfli SMS kelganda farzandingizga darhol xabar berish uchun,<br>yoki favqulodda yordam tugmasi orqali qo\'ng\'iroq qilishda ishlatiladi.<br>Xohlamasangiz, o\'tkazib yuborishingiz mumkin.',
      'onboard.login.desc': 'Ro\'yxatdan o\'tishda ishlatgan telefon raqami va parolingizni kiriting.',
      'onboard.login.submit': 'Kirish',
      'onboard.login.title': 'Kirish',
      'onboard.login.toSignup': 'Hisobingiz yo\'qmi? Ro\'yxatdan o\'tish',
      'onboard.login.voice': 'Kirish uchun telefon raqami va parolingizni kiriting.',
      'onboard.signup.desc': 'Telefon raqami va parol bilan hisob yarating.<br>Bu hisob orqali boshqa qurilmada ham ma\'lumotlaringizni davom ettirib ishlatishingiz mumkin.',
      'onboard.signup.errorGeneric': 'Ro\'yxatdan o\'tish amalga oshmadi, birozdan keyin qayta urinib ko\'ring',
      'onboard.signup.errorPhoneExists': 'Bu telefon raqami allaqachon ro\'yxatdan o\'tgan. Kirish qiling',
      'onboard.signup.pinLabel': 'Parol (4 xonali raqam)',
      'onboard.signup.submit': 'Ro\'yxatdan o\'tish',
      'onboard.signup.title': 'Ro\'yxatdan o\'tish',
      'onboard.signup.toLogin': 'Hisobingiz bormi? Kirish',
      'onboard.signup.voice': 'Ro\'yxatdan o\'tish uchun ism, telefon raqami va 4 xonali parolni kiriting.',
  }
};
